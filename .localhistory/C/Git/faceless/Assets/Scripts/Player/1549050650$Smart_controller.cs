...
public class Smart_controller : MonoBehaviour
{
     ...
     */
    public Vector2 Character_rotation_speed_limit = new Vector2(
        Mathf.PI / 8.0f,
        Mathf.PI / 8.0f);
    ...
    */
    ...
    private Vector2 character_current = new Vector2();
    private Vector2 character_delta = new Vector2();
    ...
    void FixedUpdate()
    {
        ...
        look_delta.Set(
            look_aim.x - look_current.x,
            look_aim.y - look_current.y);

        look_current.Set(
            look_current.x + Mathf.Clamp(look_delta.x, -look_limit_x, look_limit_x),
            look_current.y + Mathf.Clamp(look_delta.y, -look_limit_y, look_limit_y));
        ...
        float character_rotation_limit_x = Character_rotation_speed_limit.x * Time.fixedDeltaTime;
        float character_rotation_limit_y = Character_rotation_speed_limit.y * Time.fixedDeltaTime;

        // TODO: consider using Y component to affect character' head vertical rotation

        character_current.Set(
            );
