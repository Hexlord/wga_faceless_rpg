...
public class Smart_controller : MonoBehaviour
{
    ...
    public Vector2 Look_speed = new Vector2(1.0f / 1024.0f, 1.0f / 1024.0f);
    ...
    */
    ...
    void FixedUpdate()
    {
        ...
        look_aim.Set(
            look_aim.x + Mathf.Clamp(input_delta.x * Look_speed, -aim_limit_x, aim_limit_x),
            look_aim.y + Mathf.Clamp(input_delta.y * Look_speed, -aim_limit_y, aim_limit_y));
