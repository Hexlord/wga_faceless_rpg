    ...
    */
    ...
    void FixedUpdate()
    {
        ...
        if (is_player_rotating)
        {
            ...
            //player_transform.Rotate(new Vector3(0.1f, 0.1f, 0.1f));
            Quaternion q = Quaternion.Euler(new Vector3(player_current.x, player_current.y, 11.0f));
            player_transform.rotation.Set(q.x, q.y, q.z, q.w);
            player_transform.rotation.SetEulerAngles();
        }
