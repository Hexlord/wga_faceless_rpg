    ...
    */
    ...
    void FixedUpdate()
    {
        ...
        if (is_player_rotating)
        {
            ...
            Quaternion target = Quaternion.Euler(player_current.x, player_current.y, 0.0f);

            player_transform.eulerAngles.x = player_current.x;
            player_transform.eulerAngles.y = player_current.y;
        }
