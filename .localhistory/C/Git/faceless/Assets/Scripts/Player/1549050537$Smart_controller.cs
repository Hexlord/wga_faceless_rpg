...
public class Smart_controller : MonoBehaviour
{
    ...
    */
    ...
    void FixedUpdate()
    {
        ...
        float character_limit_x = Character_rotation_speed_limit.x * Time.fixedDeltaTime;
        float character_limit_y = Character_rotation_speed_limit.y * Time.fixedDeltaTime;

        // TODO: consider using Y component to affect head vertical rotation
