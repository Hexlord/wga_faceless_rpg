...
public class Smart_controller : MonoBehaviour
{
    ...
    */
    ...
    void FixedUpdate()
    {
        ...
        look_aim.Set(
            look_aim.x + Mathf.Clamp(input_delta.x, -Look_aim_speed_limit.x, Look_aim_speed_limit.x),
            look_aim.y + Mathf.Clamp(input_delta.y, -Look_aim_speed_limit.y, Look_aim_speed_limit.y));
