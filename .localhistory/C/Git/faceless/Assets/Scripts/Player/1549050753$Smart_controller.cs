...
public class Smart_controller : MonoBehaviour
{
    ...
    */
    ...
    void FixedUpdate()
    {
        ...
        float player_rotation_limit_x = Character_rotation_speed_limit.x * Time.fixedDeltaTime;
        float player_rotation_limit_y = Character_rotation_speed_limit.y * Time.fixedDeltaTime;
