...
/*
 * It uses transform for movement, so it ignores collisions
 * 
...
public class Familiar : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        audioFly = transform.Find("Wings").gameObject.GetComponent<AudioSource>();
        audioRest = transform.Find("Mouth").gameObject.GetComponent<AudioSource>();
